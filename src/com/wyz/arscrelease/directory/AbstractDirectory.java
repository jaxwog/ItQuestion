  ...
  implements Directory
{
  ...
  public InputStream getFileInput(String path) throws com.wyz.arscrelease.directory.DirectoryException
  {
  ...
  public OutputStream getFileOutput(String path) throws com.wyz.arscrelease.directory.DirectoryException
  {
    Directory dir;
  ...
  public Directory getDir(String path) throws com.wyz.arscrelease.directory.PathNotExist
  {
    SubPath subpath = getSubPath(path);
    if (subpath.dir != null)
    ...
    if (!(getAbstractDirs().containsKey(subpath.path)))
      throw new com.wyz.arscrelease.directory.PathNotExist(path);

    return ((Directory)getAbstractDirs().get(subpath.path));
  }

  public Directory createDir(String path) throws com.wyz.arscrelease.directory.DirectoryException
  {
  ...
  private SubPath getSubPath(String path) throws com.wyz.arscrelease.directory.PathNotExist {
    ParsedPath parsed = parsePath(path);
    if (parsed.dir == null)
  ...
  protected abstract InputStream getFileInputLocal(String paramString) throws com.wyz.arscrelease.directory.DirectoryException;

  protected abstract OutputStream getFileOutputLocal(String paramString) throws com.wyz.arscrelease.directory.DirectoryException;

  protected abstract AbstractDirectory createDirLocal(String paramString) throws com.wyz.arscrelease.directory.DirectoryException;
